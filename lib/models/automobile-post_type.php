...
if ( in_array("yes", $get_automobile_post_id ) && $_POST[ 'txt_automobile_sku' ] != $txt_automobile_sku_now ) {
	...
	if( isset( $_POST[ 'txt_automobile_year_to' ] ) )
	{ $txt_automobile_year_to = $_POST[ 'txt_automobile_year_to' ]; } else { $txt_automobile_year_to = ''; }
	...
	{ $automobile_inquiry = $_POST[ 'automobile_inquiry' ]; } else { $automobile_inquiry = ''; }
        ...
        $advanced_automobile_array = array(
			...
			'txt_automobile_year_to'   => $txt_automobile_year_to,
		...
		update_post_meta($post_id, 'txt_automobile_year_to', $txt_automobile_year_to);
    ...
    <div id="automobile-admin">
        ...
        <div class="options-wrap">
            <div class="automobile">
                <ul>
					<li class="shortcode first"><a href="#automobile_attributes"><i class="icon-trello"></i><?php echo _e('Attributes', 'automobileoptions'); ?></a></li>
                    <?php /* ?><li class="general"><a href="#automobile_make"><i class="icon-cogs"></i><?php echo _e('Make', 'automobileoptions'); ?></a></li>
                    <li class="shortcode"><a href="#automobile_model"><i class="icon-trello"></i><?php echo _e('Model', 'automobileoptions'); ?></a></li>
					<li class="shortcode"><a href="#automobile_year"><i class="icon-trello"></i><?php echo _e('Year', 'automobileoptions'); ?></a></li><?php */ ?>
                ...
                <div class="options-form">
                    ...
                    <div class="automobile_content">
						...
						<div id="automobile_attributes" class="automobile_block">
							<h2><?php _e('Automobile attributes', 'automobileoptions'); ?></h2>
						<div class="fields_wrap">
							<span id="automobile_attributes_add">
							<div class="attributes">
                                <label for="attributes_make_id">Make</label>
                                <input type="text" name="attributes_make" class="" id="attributes_make_id"/>
							</div><div class="attributes">
								<label for="attributes_model_id">Model</label>
								<input type="text" name="attributes_model" class="" id="attributes_model_id"/>
							</div><div class="attributes">
								<label for="attributes_year_id">Year</label>
								<input type="text" name="attributes_year" class="" id="attributes_year_id"/>
							</div>
							<div class="attributes attributes_submit">
                                <input type="submit" name="attributes_submit" id="attributes_submit" class="button-primary" value="Add New">
								<span class="reloadIcon" style="display:none"></span>
							</div>
                            </span>
							
							<span id="automobile_attributes_edit" style="display:none;">
							<div class="attributes">
                                <label for="attributes_make_edit_id">Make</label>
                                <input type="text" name="attributes_make_edit" class="" id="attributes_make_edit_id"/>
							</div><div class="attributes">
								<label for="attributes_model_edit_id">Model</label>
								<input type="text" name="attributes_model_edit" class="" id="attributes_model_edit_id"/>
							</div><div class="attributes">
								<label for="attributes_year_edit_id">Year</label>
								<input type="text" name="attributes_year_edit" class="" id="attributes_year_edit_id"/>
							</div>
							<div class="attributes attributes_submit">
                                <input type="submit" name="attributes_submit_edit" id="attributes_submit_edit" class="button-primary" value="Edit">
								<span class="reloadIcon" style="display:none"></span>
							</div>
                            </span>
							...
							<ul id="attributes_display_area">
							<li class="heading"><?php _e('Make', 'automobileoptions'); ?></li>
							<li class="heading"><?php _e('Model', 'automobileoptions'); ?></li>
							<li class="heading"><?php _e('Year', 'automobileoptions'); ?></li>
							<li class="action heading">&nbsp;</li>
								<?php
                                    $auto_mobile_attributes = '_auto_mobile_attributes';
                                    $get_auto_mobile_attributes = get_option( $auto_mobile_attributes );
                                    $get_auto_mobile_attributes_uns = @unserialize($get_auto_mobile_attributes);
                                    if($get_auto_mobile_attributes_uns) {
										$inc = 1;
                                        foreach ($get_auto_mobile_attributes_uns as $key=>$get_auto_mobile_attributes_unss):
										if($inc%2==0): $liClass = 'even'; else : $liClass = 'odd'; endif;
										?>
										<li class="<?php echo $liClass.' '.$key; ?>"><?php echo $get_auto_mobile_attributes_unss['make']; ?></li>
										<li class="<?php echo $liClass.' '.$key; ?>"><?php echo $get_auto_mobile_attributes_unss['model']; ?></li>
										<li class="<?php echo $liClass.' '.$key; ?>"><?php echo $get_auto_mobile_attributes_unss['year']; ?></li>
										<li class="action <?php echo $liClass.' '.$key; ?>"><a href='javascript:void(0)' class='attributes_del delIcon' onclick='attributes_del(this)' data-keys='<?php echo $key; ?>'><i class='fa fa-times'></i></a><a href='javascript:void(0)' class='attributes_edit editIcon' onclick='attributes_edit(this)' data-keys='<?php echo $key; ?>' data-make_value='<?php echo $get_auto_mobile_attributes_unss['make']; ?>' data-model_value='<?php echo $get_auto_mobile_attributes_unss['model']; ?>' data-year_value='<?php echo $get_auto_mobile_attributes_unss['year']; ?>'><i class='fa fa-pencil-square-o'></i></a></li>                       
                                <?php $inc++; endforeach; } ?>
                            </ul>
                        ...
                        <?php /* ?><div id="automobile_make" class="automobile_block">
 ...
 <ul class='tabs tabs-menu'>
  ...
  <div id='general'>
   ...
   <p>
       ...
       <input type="text" onkeyup="check_number(this)" onkeypress="check_number(this)" name="txt_automobile_regular_price" id="txt_automobile_regular_price" size="50" value="<?php echo get_post_meta($post->ID, 'txt_automobile_regular_price', true); ?>" />
       <em></em>
   </p>
  <p>
       <label class="left-lable"  for="txt_automobile_price"><?php _e('Special Price ($)', 'automobile_plugin'); ?>: </label>
       <input type="text" onkeyup="check_number(this)" onkeypress="check_number(this)" name="txt_automobile_price" id="txt_automobile_price" size="50" value="<?php echo get_post_meta($post->ID, 'txt_automobile_price', true); ?>" />
       <em></em>
   </p>
   <div class="border-sep"></div>
   <p>
   ...
   <p>
       ...
       <input type="text" onkeyup="check_number(this)" onkeypress="check_number(this)" name="txt_automobile_qty" id="txt_automobile_qty" size="50" value="<?php echo get_post_meta($post->ID, 'txt_automobile_qty', true); ?>" />
       <em></em>
   </p>
   <p>
...
?>
	 ...
	 <p>
        ...
        <select name="txt_automobile_make" id="txt_automobile_make_admin">
	...
	<p>
        ...
        <select name="txt_automobile_model" id="txt_automobile_model_admin" disabled>
            <option value="">None</option>
            <?php
            $auto_mobile_model = '_auto_mobile_attributes';
            $get_auto_mobile_model = get_option( $auto_mobile_model );
            $get_auto_mobile_model_uns = @unserialize($get_auto_mobile_model);
            if($get_auto_mobile_model_uns) {
                foreach ($get_auto_mobile_model_uns as $key=>$get_auto_mobile_model_unss): ?>
                    <option value="<?php echo $get_auto_mobile_model_unss['model']; ?>" <?php if ( isset ( $get_advanced_automobile['txt_automobile_model'] ) ) selected( $get_advanced_automobile['txt_automobile_model'], $get_auto_mobile_model_unss['model'] ); ?>><?php _e( $get_auto_mobile_model_unss['model'], 'automobile_plugin' )?></option>';
                <?php  endforeach;
            }
            ?>
        </select>
	...
	<p>
	<label for="txt_automobile_year" class="left-lable"><?php _e( 'From year', 'automobile_plugin' )?></label>
        <select name="txt_automobile_year" id="txt_automobile_year_admin" disabled>
            <option value="">None</option>
            <?php
            $auto_mobile_year = '_auto_mobile_attributes';
            $get_auto_mobile_year = get_option( $auto_mobile_year );
            $get_auto_mobile_year_uns = @unserialize($get_auto_mobile_year);
            if($get_auto_mobile_year_uns) {
                foreach ($get_auto_mobile_year_uns as $key=>$get_auto_mobile_year_unss): ?>
                    <option value="<?php echo $get_auto_mobile_year_unss['year']; ?>" <?php if ( isset ( $get_advanced_automobile['txt_automobile_year'] ) ) selected( $get_advanced_automobile['txt_automobile_year'], $get_auto_mobile_year_unss['year'] ); ?>><?php _e( $get_auto_mobile_year_unss['year'], 'automobile_plugin' )?></option>';
                <?php  endforeach;
            }
            ?>
        </select>
	...
	<p>
	<label for="txt_automobile_year_to" class="left-lable"><?php _e( 'Year to', 'automobile_plugin' )?></label>
		<select name="txt_automobile_year_to" id="txt_automobile_year_to_admin" disabled>
            <option value="">None</option>
            <?php
            $auto_mobile_year = '_auto_mobile_attributes';
            $get_auto_mobile_year = get_option( $auto_mobile_year );
            ...
            if($get_auto_mobile_year_uns) {
                foreach ($get_auto_mobile_year_uns as $key=>$get_auto_mobile_year_unss): ?>
                    <option value="<?php echo $get_auto_mobile_year_unss['year']; ?>" <?php if ( isset ( $get_advanced_automobile['txt_automobile_year_to'] ) ) selected( $get_advanced_automobile['txt_automobile_year_to'], $get_auto_mobile_year_unss['year'] ); ?>><?php _e( $get_auto_mobile_year_unss['year'], 'automobile_plugin' )?></option>';
                <?php  endforeach;
            }
            ?>
        </select>
