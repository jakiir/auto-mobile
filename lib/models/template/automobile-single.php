                            ...
                            <section class="product-details">
                              <p>
								...
								<span class="adv_result">:
									<?php echo get_post_meta($post->ID, 'txt_automobile_color', true); ?>
								</span>
							</p>
							<p>
...
<table class="table table-hover">
    ...
    <tbody>
      <tr>
        <td><?php 
        echo $txt_automobile_year = get_post_meta($post->ID, 'advanced_automobile_year', true);          
        ?></td>
        <td><?php 
		echo $txt_automobile_make = get_post_meta($post->ID, 'advanced_automobile_make', true);        
        ?></td>
        <td><?php 
        echo $txt_automobile_model = get_post_meta($post->ID, 'advanced_automobile_model', true);
        ?></td>
