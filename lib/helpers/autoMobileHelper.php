    ...
    $screen = get_current_screen();
        ...
        echo '<li><select disabled class="form-control"  name="txt_automobile_make" id="txt_automobile_make_dropdown"><option value="">Show All Make</option>';         if($get_auto_mobile_make_uns) {
            foreach ($get_auto_mobile_make_uns as $key=>$get_auto_mobile_make_unss): ?>
                <option value="<?php echo $get_auto_mobile_make_unss['make']; ?>" <?php if ( isset ( $_GET['txt_automobile_make'] ) ) selected( $_GET['txt_automobile_make'], $get_auto_mobile_make_unss['make'] ); ?>><?php _e( $get_auto_mobile_make_unss['make'], 'automobile_plugin' )?></option>';         <?php  endforeach;
        }
        echo '</select></li>';
        ...
        echo '<li><select disabled class="form-control"  name="txt_automobile_model" id="txt_automobile_model_dropdown"><option value="">Show All Model</option>';
            if($get_auto_mobile_model_uns) {
                foreach ($get_auto_mobile_model_uns as $key=>$get_auto_mobile_model_unss): ?>
                    <option value="<?php echo $get_auto_mobile_model_unss['model']; ?>" <?php if ( isset ( $_GET['txt_automobile_model'] ) ) selected( $_GET['txt_automobile_model'], $get_auto_mobile_model_unss['model'] ); ?>><?php _e( $get_auto_mobile_model_unss['model'], 'automobile_plugin' )?></option>';
                <?php  endforeach;
            }
        echo '</select></li>';
...
function automobile_search_by_model() {
	echo '<ul>';
		...
		if($get_auto_mobile_model_uns) {
			foreach ($get_auto_mobile_model_uns as $key=>$get_auto_mobile_model_unss): ?>
				<li><a href="<?php echo home_url('/auto-mobile/?txt_automobile_model='.$get_auto_mobile_model_unss['model']); ?>"><i class="fa fa-arrow-circle-right"></i><?php _e( $get_auto_mobile_model_unss['model'], 'automobile_plugin' ); ?></a></li>
			<?php  endforeach;
		}
	echo '</ul>';
