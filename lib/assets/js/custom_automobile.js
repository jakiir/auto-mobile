          ...
          success: function(data){
            ...
            if(obj['success'] == true){
                ...
                for (var prop in obj['make']) {
                    txt_automobile_make_dropdown.append('<option value="'+obj['make'][prop]+'">' + obj['make'][prop] + '</option>');
                }
                ...
                for (var prop in obj['model']) {
                    txt_automobile_model_dropdown.append('<option value="'+obj['model'][prop]+'">' + obj['model'][prop] + '</option>');
                }
